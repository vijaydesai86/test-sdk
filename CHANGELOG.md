...
## [Unreleased]
### Added
- **Saved-report Improve workflow**: Added a generic report-id-driven improve path for saved stock, comparison, research, and watchlist reports. Improve uses the existing four report tools, clamps pass counts, saves new report versions, and continues only while structured coverage improves.
